                                    ...
                                    >
                                        ...
                                        <div className="relative">
                                            ...
                                            <div className="absolute top-4 left-4">
                                                ...
                                                <div
                                                    className={`flex items-center gap-2 px-3 py-1 rounded-full text-sm font-semibold shadow-lg ${
                                                        isOnline
                                            ...
                                            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 to-transparent p-6">
                                                ...
                                                <h2
                                                    ...
                                                    className="text-2xl font-bold text-white cursor-pointer hover:text-pink-300 transition"
                                                >
